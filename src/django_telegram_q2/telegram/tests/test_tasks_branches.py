...
class PipelineTaskBranchTests(TestCase):
    ...
    @patch(
        "django_telegram_q2.telegram.tasks.Bot.objects.select_for_update",
    ...
    def test_ingest_skips_bot_deleted_between_transactions(self):
        ...
        with patch(
            ...
            side_effect=_delete_and_return,
        ):
            telegram_ingest()
    ...
    @patch("django_telegram_q2.telegram.tasks.get_updates", return_value=[])
    ...
    @patch("django_telegram_q2.telegram.tasks.logger")
    @patch(
        "django_telegram_q2.telegram.tasks.get_updates",
        return_value=[
            {"update_id": 10},
    ...
    @patch("django_telegram_q2.telegram.tasks.logger")
    @patch(
        "django_telegram_q2.telegram.tasks.Bot.objects.filter",
...
class WebhookManagementTests(TestCase):
    ...
    @patch("django_telegram_q2.telegram.tasks.get_updates", return_value=[])
    @patch(
        "django_telegram_q2.telegram.tasks.get_webhook_info",
        return_value={"url": "", "pending_update_count": 0},
    )
    @patch("django_telegram_q2.telegram.tasks.set_webhook", return_value={})
    ...
    @patch("django_telegram_q2.telegram.tasks.set_webhook")
    ...
    @override_settings(BASE_URL="https://example.com")
    @patch("django_telegram_q2.telegram.tasks.get_updates", return_value=[])
    @patch("django_telegram_q2.telegram.tasks.get_webhook_info")
    @patch("django_telegram_q2.telegram.tasks.delete_webhook", return_value={})
    ...
    @patch("django_telegram_q2.telegram.tasks.get_webhook_info")
    @patch(
        "django_telegram_q2.telegram.tasks.set_webhook",
    ...
    @patch(
        "django_telegram_q2.telegram.tasks.delete_webhook",
    ...
    @patch("django_telegram_q2.telegram.tasks.delete_webhook")
    ...
    @patch("django_telegram_q2.telegram.tasks.logger")
    @patch(
        "django_telegram_q2.telegram.tasks._manage_webhook_for_bot",
...
class TelegramAckTests(TestCase):
    ...
    @patch("django_telegram_q2.telegram.tasks.set_message_reaction")
    ...
    @patch(
        "django_telegram_q2.telegram.tasks.set_message_reaction",
...
class IntakeFlushTests(TestCase):
    ...
    def test_flush_creates_job_from_due_buffer(self):
        ...
        from ..tasks import telegram_flush_intake_buffers
    ...
    def test_flush_due_buffer_flushes_ripe_buffer(self):
        ...
        from ..tasks import _flush_due_buffer
