...
class TelegramHttpClientTests(TestCase):
    ...
    @patch("django_telegram_q2.telegram.client._http.request")
    ...
    def test_send_document_posts_file_payload(self, mock_request):
        from ..client import send_document
    ...
    def test_non_json_response_on_http_200_logs_warning(self):
        ...
        with self.assertLogs(
            "django_telegram_q2.telegram.client", level="WARNING"
        ) as logs:
            _raise_for_status(response)
        ...
        self.assertEqual(
            ...
            [
                (
                    "WARNING:django_telegram_q2.telegram.client:Telegram API returned"
    ...
    def test_set_webhook_posts_expected_payload(self, mock_request):
        from ..client import set_webhook
    ...
    def test_set_message_reaction_posts_expected_payload(self, mock_request):
        from ..client import set_message_reaction
    ...
    def test_delete_webhook_posts_expected_payload(self, mock_request):
        from ..client import delete_webhook
    ...
    def test_get_webhook_info_returns_result(self, mock_request):
        from ..client import get_webhook_info
